...
test_es_conjugate_mood_tense_data = [
    ...
    ('parecer', 'indicativo', 'presente',
        ['yo parezco', 'tú pareces', 'él parece', 'nosotros parecemos', 'vosotros parecéis', 'ellos parecen']),
    ('parecer', 'indicativo', 'pretérito-imperfecto',
        ['yo parecía', 'tú parecías', 'él parecía', 'nosotros parecíamos', 'vosotros parecíais', 'ellos parecían']),
    ('parecer', 'indicativo', 'pretérito-perfecto-simple',
        ['yo parecí', 'tú pareciste', 'él pareció', 'nosotros parecimos', 'vosotros parecisteis', 'ellos parecieron']),
    ('parecer', 'indicativo', 'futuro',
        ['yo pareceré', 'tú parecerás', 'él parecerá', 'nosotros pareceremos', 'vosotros pareceréis', 'ellos parecerán']),
    ('parecer', 'subjuntivo', 'presente',
        ['yo parezca', 'tú parezcas', 'él parezca', 'nosotros parezcamos', 'vosotros parezcáis', 'ellos parezcan']),
    ('parecer', 'subjuntivo', 'pretérito-imperfecto-1',
        ['yo pareciera', 'tú parecieras', 'él pareciera', 'nosotros pareciéramos', 'vosotros parecierais', 'ellos parecieran']),
    ('parecer', 'subjuntivo', 'pretérito-imperfecto-2',
        ['yo pareciese', 'tú parecieses', 'él pareciese', 'nosotros pareciésemos', 'vosotros parecieseis', 'ellos pareciesen']),
    ('parecer', 'subjuntivo', 'futuro',
        ['yo pareciere', 'tú parecieres', 'él pareciere', 'nosotros pareciéremos', 'vosotros pareciereis', 'ellos parecieren']),
    ('parecer', 'imperativo', 'afirmativo',
        ['parece', 'parezca', 'parezcamos', 'pareced', 'parezcan']),
    ('parecer', 'imperativo', 'negativo',
        ['no parezcas', 'no parezca', 'no parezcamos', 'no parezcáis', 'no parezcan']),
    ('parecer', 'condicional', 'presente',
