...
test_ca_conjugate_mood_tense_data = [
    ...
    ('parlar', 'indicatiu', 'passat-simple',
    ...
    ('caure', 'indicatiu', 'present',
        ['jo caic', 'tu caus', 'ell cau', 'nosaltres caiem', 'vosaltres caieu', 'ells cauen']),
    ('collar', 'indicatiu', 'present',
        ['jo collo', 'tu colles', 'ell colla', 'nosaltres collem', 'vosaltres colleu', 'ells collen']),
    ('collir', 'indicatiu', 'present',
        ['jo cullo', 'tu culls', 'ell cull', 'nosaltres collim', 'vosaltres colliu', 'ells cullen']),
    ('dormir', 'indicatiu', 'present',
        ['jo dormo', 'tu dorms', 'ell dorm', 'nosaltres dormim', 'vosaltres dormiu', 'ells dormen']),
    ('tossir', 'indicatiu', 'present',
        ['jo tusso', 'tu tusses', 'ell tus', 'nosaltres tossim', 'vosaltres tossiu', 'ells tussen']),
    ('collir', 'subjuntiu', 'present',
        ['jo culli', 'tu cullis', 'ell culli', 'nosaltres collim', 'vosaltres colliu', 'ells cullin']),
    ('dormir', 'subjuntiu', 'present',
        ['jo dormi', 'tu dormis', 'ell dormi', 'nosaltres dormim', 'vosaltres dormiu', 'ells dormin']),
    ('tossir', 'subjuntiu', 'present',
        ['jo tussi', 'tu tussis', 'ell tussi', 'nosaltres tossim', 'vosaltres tossiu', 'ells tussin']),
    ('dir', 'indicatiu', 'present',
        ['jo dic', 'tu dius', 'ell diu', 'nosaltres diem', 'vosaltres dieu', 'ells diuen']),
    ('anar', 'indicatiu', 'present',
        ['jo vaig', 'tu vas', 'ell va', 'nosaltres anem', 'vosaltres aneu', 'ells van']),
    ('poder', 'indicatiu', 'present',
        ['jo puc', 'tu pots', 'ell pot', 'nosaltres podem', 'vosaltres podeu', 'ells poden']),
    ('arribar', 'indicatiu', 'present',
        ['jo arribo', 'tu arribes', 'ell arriba', 'nosaltres arribem', 'vosaltres arribeu', 'ells arriben']),
    ('trobar', 'indicatiu', 'present',
        ['jo trobo', 'tu trobes', 'ell troba', 'nosaltres trobem', 'vosaltres trobeu', 'ells troben']),
    ('partir', 'indicatiu', 'present',
        ['jo parteixo', 'tu parteixes', 'ell parteix', 'nosaltres partim', 'vosaltres partiu', 'ells parteixen']),
