# python library, dockerized microservice and web app for verb conjugation in French, Spanish, Italian, Portuguese, Romanian and Catalan, powered by machine learning
